...
function ChangeTheme(ThemeName)
    ...
    for _, TabPage in ipairs(Elements:GetChildren()) do
        for _, Element in ipairs(TabPage:GetChildren()) do
            if
                Element.ClassName == "Frame" and Element.Name ~= "Placeholder" and Element.Name ~= "SectionSpacing" and
        ...
        function()
            ...
            if NotificationSettings.Actions then
                for _, Action in pairs(NotificationSettings.Actions) do
                    ...
                    NewAction.MouseButton1Click:Connect(
                        function()
                ...
                if element.ClassName == "Frame" then
                    if element.Name ~= "SectionSpacing" and element.Name ~= "Placeholder" then
                        ...
                        for _, child in ipairs(element:GetChildren()) do
                            if
                                child.ClassName == "Frame" or child.ClassName == "TextLabel" or
                                    child.ClassName == "TextBox" or
                                    child.ClassName == "ImageButton" or
                                    child.ClassName == "ImageLabel"
                             then
                                child.Visible = false
                            end
                        end
...
function RayfieldLibrary:CreateWindow(Settings)
    ...
    if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
        LoadingFrame.Version.Text = "Dark_Turns UI"
    end
    ...
    function Window:CreateTab(Name, Image)
        ...
        TabButton.Interact.MouseButton1Click:Connect(
            function()
                if Minimised then
                    return
                end
                ...
                for _, OtherTabButton in ipairs(TabList:GetChildren()) do
                    if
                        OtherTabButton.Name ~= "Template" and OtherTabButton.ClassName == "Frame" and
                            OtherTabButton ~= TabButton and
                            OtherTabButton.Name ~= "Placeholder"
                     then
                        TweenService:Create(
                            OtherTabButton,
                            TweenInfo.new(0.7, Enum.EasingStyle.Quint),
        ...
        function Tab:CreateButton(ButtonSettings)
            ...
            Button.Interact.MouseButton1Click:Connect(
                function()
        ...
        function Tab:CreateColorPicker(ColorPickerSettings) -- by Throit
            ...
            ColorPicker.Interact.MouseButton1Down:Connect(
                function()
                    if not opened then
                        opened = true
                        TweenService:Create(
            ...
            Main.MainPoint.MouseButton1Down:Connect(
                function()
                    if opened then
                        mainDragging = true
                    end
            ...
            Slider.SliderPoint.MouseButton1Down:Connect(
                function()
                    sliderDragging = true
                end
            )
            ...
            setDisplay()
            ColorPicker.HexInput.InputBox.FocusLost:Connect(
                function()
                    if
                        not pcall(
                            function()
            ...
            ColorPicker.RGB.RInput.InputBox.FocusLost:connect(
                function()
            ...
            ColorPicker.RGB.GInput.InputBox.FocusLost:connect(
                function()
            ...
            ColorPicker.RGB.BInput.InputBox.FocusLost:connect(
                function()
        ...
        function Tab:CreateDropdown(DropdownSettings)
            ...
            Dropdown.Interact.MouseButton1Click:Connect(
                function()
                    TweenService:Create(
                        Dropdown,
                        TweenInfo.new(0.4, Enum.EasingStyle.Quint),
                ...
                DropdownOption.Interact.MouseButton1Click:Connect(
                    function()
                        ...
                        for _, droption in ipairs(Dropdown.List:GetChildren()) do
                            if
                                droption.ClassName == "Frame" and droption.Name ~= "Placeholder" and
                                    not table.find(DropdownSettings.CurrentOption, droption.Name)
                             then
                                TweenService:Create(
                                    droption,
                                    TweenInfo.new(0.3, Enum.EasingStyle.Quint),
        ...
        function Tab:CreateKeybind(KeybindSettings)
            ...
            Keybind.KeybindFrame.KeybindBox.Focused:Connect(
                function()
                    CheckingForKey = true
                    Keybind.KeybindFrame.KeybindBox.Text = ""
                end
            )
            Keybind.KeybindFrame.KeybindBox.FocusLost:Connect(
                function()
            ...
            UserInputService.InputBegan:Connect(
                function(input, processed)
                    ...
                    elseif
                        KeybindSettings.CurrentKeybind ~= nil and
                            (input.KeyCode == Enum.KeyCode[KeybindSettings.CurrentKeybind] and not processed)
                     then -- Test
                        local Held = true
                        local Connection
                        Connection =
            ...
            Keybind.KeybindFrame.KeybindBox:GetPropertyChangedSignal("Text"):Connect(
                function()
                    TweenService:Create(
        ...
        function Tab:CreateToggle(ToggleSettings)
            ...
            Toggle.Interact.MouseButton1Click:Connect(
                function()
        ...
        function Tab:CreateSlider(SliderSettings)
            ...
            Slider.Main.Progress.Size =
                ...
                Slider.Main.AbsoluteSize.X *
                    ...
                    5 and
                    Slider.Main.AbsoluteSize.X *
                        (SliderSettings.CurrentValue / (SliderSettings.Range[2] - SliderSettings.Range[1])) or
                    5,
                1,
                0
            )
            ...
            Slider.Main.Interact.InputBegan:Connect(
                function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                        Dragging = true
                    end
            ...
            Slider.Main.Interact.InputEnded:Connect(
                function(Input)
                    if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                        Dragging = false
                    end
            ...
            Slider.Main.Interact.MouseButton1Down:Connect(
                function(X)
                                    ...
                                    TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                                    {
                                        Size = UDim2.new(
                                            ...
                                            Location - Slider.Main.AbsolutePosition.X > 5 and
                                                Location - Slider.Main.AbsolutePosition.X or
                                                5,
                                            1,
                                            0
                                        )
                    ...
                    TweenInfo.new(0.45, Enum.EasingStyle.Quint, Enum.EasingDirection.Out),
                    {
                        Size = UDim2.new(
                            ...
                            Slider.Main.AbsoluteSize.X *
                                ...
                                5 and
                                Slider.Main.AbsoluteSize.X *
                                    (NewVal / (SliderSettings.Range[2] - SliderSettings.Range[1])) or
                                5,
                            1,
                            0
                        )
...
Topbar.ChangeSize.MouseButton1Click:Connect(
    function()
        if Debounce then
            return
        end
...
Topbar.Hide.MouseButton1Click:Connect(
    function()
        if Debounce then
            return
        end
...
for _, TopbarButton in ipairs(Topbar:GetChildren()) do
    if TopbarButton.ClassName == "ImageButton" then
        TopbarButton.MouseEnter:Connect(
            function()
        ...
        TopbarButton.MouseLeave:Connect(
            function()
                TweenService:Create(TopbarButton, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {ImageTransparency = 0.8}):Play(
