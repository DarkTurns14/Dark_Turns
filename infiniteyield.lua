...
Title.TextSize = 18
Title.Text = "IY, Dark_Turns v" .. currentVersion
...
eventEditor =
    ...
    settingsFrame:WaitForChild("Close").MouseButton1Click:Connect(
        function()
    ...
    local function setupCheckbox(button, callback)
        ...
        button.On.MouseButton1Click:Connect(
            function()
                enabled = not enabled
                update()
                if callback then
    ...
    local function openSettingsEditor(event, cmd)
        ...
        delayEditor.Secs.FocusLost:Connect(
            function()
        ...
        for i, v in pairs(event.sets) do
            if v.Type == "Player" then
                ...
                customTextBox.FocusLost:Connect(
                    function()
    ...
    local function refreshList()
        ...
        for name, event in pairs(events) do
            ...
            eventF.Expand.MouseButton1Down:Connect(
                function()
            ...
            local function refreshCommands()
                ...
                for i, cmd in pairs(event.commands) do
                    ...
                    cmdF.Settings.MouseButton1Click:Connect(
                        function()
                            openSettingsEditor(event, cmd)
                        end
                    )

                    cmdF.Delete.MouseButton1Click:Connect(
                        function()
    ...
    main.TopBar.Close.MouseButton1Click:Connect(
        function()
...
reference =
    ...
    ReferenceButton.MouseButton1Click:Connect(
        function()
                ...
                local success, response =
                    ...
                    function()
                        ...
                        if json.currentShade2 ~= nil then
                            currentShade2 =
                                Color3.new(json.currentShade2[1], json.currentShade2[2], json.currentShade2[3])
                        end
                        if json.currentShade3 ~= nil then
                            currentShade3 =
                                Color3.new(json.currentShade3[1], json.currentShade3[2], json.currentShade3[3])
                        end
                        ...
                        if json.currentScroll ~= nil then
                            currentScroll =
                                Color3.new(json.currentScroll[1], json.currentScroll[2], json.currentScroll[3])
                        end
                        if json.eventBinds ~= nil then
...
function notify(text, text2, length)
    task.spawn(
        function()
            ...
            pinNotification =
                PinButton.MouseButton1Click:Connect(
                function()
                    task.spawn(
                        function()
                            pinNotification:Disconnect()
...
ColorsButton.MouseButton1Click:Connect(
    function()
            ...
            do
                ...
                ColorPicker.new = function()
                    ...
                    local function hookButtons(frame, func)
                        frame.ArrowFrame.Up.InputBegan:Connect(
                            function(input)
                        ...
                        frame.ArrowFrame.Up.InputEnded:Connect(
                            function(input)
                                if input.UserInputType == Enum.UserInputType.MouseMovement then
                        ...
                        frame.ArrowFrame.Down.InputBegan:Connect(
                            function(input)
                                if input.UserInputType == Enum.UserInputType.MouseMovement then
                        ...
                        frame.ArrowFrame.Down.InputEnded:Connect(
                            function(input)
                                if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    for i, v in pairs(basicColors) do
                        ...
                        newColor.MouseButton1Click:Connect(
                            function()
                    ...
                    for i = 1, 12 do
                        ...
                        newColor.MouseButton2Click:Connect(
                            function()
                    ...
                    shade1Button.MouseButton1Click:Connect(
                        function()
                    ...
                    shade1Button.InputBegan:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    shade1Button.InputEnded:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    shade2Button.MouseButton1Click:Connect(
                        function()
                            if newMt.Confirm then
                    ...
                    shade2Button.InputBegan:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    shade2Button.InputEnded:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    shade3Button.MouseButton1Click:Connect(
                        function()
                            if newMt.Confirm then
                    ...
                    shade3Button.InputBegan:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    shade3Button.InputEnded:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    text1Button.MouseButton1Click:Connect(
                        function()
                            if newMt.Confirm then
                    ...
                    text1Button.InputBegan:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    text1Button.InputEnded:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    text2Button.MouseButton1Click:Connect(
                        function()
                            if newMt.Confirm then
                    ...
                    text2Button.InputBegan:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    text2Button.InputEnded:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    scrollButton.MouseButton1Click:Connect(
                        function()
                            if newMt.Confirm then
                    ...
                    scrollButton.InputBegan:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    scrollButton.InputEnded:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    cancelButton.InputBegan:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    cancelButton.InputEnded:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    defaultButton.InputBegan:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    defaultButton.InputEnded:Connect(
                        function(input)
                            if input.UserInputType == Enum.UserInputType.MouseMovement then
                    ...
                    pickerExit.MouseButton1Click:Connect(
                        function()
...
Clear_2.MouseButton1Down:Connect(
    function()
...
Toggle_2.MouseButton1Down:Connect(
    function()
        if jLogsEnabled then
            jLogsEnabled = false
            Toggle_2.Text = "Disabled"
...
selectChat.MouseButton1Down:Connect(
    function()
        join.Visible = false
        chat.Visible = true
...
selectJoin.MouseButton1Down:Connect(
    function()
        chat.Visible = false
        join.Visible = true
...
SaveChatlogs.MouseButton1Down:Connect(
    function()
...
Close_2.MouseButton1Click:Connect(
    function()
        SettingsHolder.Visible = true
...
Aliases.MouseButton1Click:Connect(
    function()
...
Close_3.MouseButton1Click:Connect(
    function()
        SettingsHolder.Visible = true
...
Positions.MouseButton1Click:Connect(
    function()
...
Exit_4.MouseButton1Click:Connect(
    function()
...
CopyPath.MouseButton1Click:Connect(
    function()
        if Path.Text ~= "" then
...
ChoosePart.MouseButton1Click:Connect(
    function()
        if Path.Text ~= "" then
            local tpNameExt = ""
...
cmds = {}
customAlias = {}
Delete_3.MouseButton1Click:Connect(
    function()
        customAlias = {}
        aliases = {}
...
PrefixBox:GetPropertyChangedSignal("Text"):Connect(
    function()
...
CMDs[#CMDs + 1] = {
    ...
    DESC = "Gives all the tools you're holding to [player] using the attach method."
}
...
for i = 1, #CMDs do
    ...
    if CMDs[i].DESC ~= "" then
        ...
        newcmd.MouseButton1Down:Connect(
            function()
...
function refresh(plr)
    ...
    task.spawn(
        function()
            plr.CharacterAdded:Wait():WaitForChild("Humanoid").RootPart.CFrame, workspace.CurrentCamera.CFrame =
                pos,
                wait() and pos1
            refreshCmd = false
        end
                ...
                if cmd then
                    ...
                    if store then
                        if speaker == Players.LocalPlayer then
                            if
                                cmdHistory[1] ~= rawCmdStr and rawCmdStr:sub(1, 11) ~= "lastcommand" and
                                    rawCmdStr:sub(1, 7) ~= "lastcmd"
                             then
...
UserInputService.TextBoxFocused:Connect(
    function(obj)
        ...
        lastTextBoxCon =
            ...
            function()
                if
                    not (UserInputService:IsKeyDown(Enum.KeyCode.Return) or
                        UserInputService:IsKeyDown(Enum.KeyCode.KeypadEnter))
                 then
                    lastTextBoxString = obj.Text
                end
            end
                ...
                if plr.Character and plr.Character:FindFirstChild("Head") then
                    ...
                    local function espLoop()
                        if COREGUI:FindFirstChild(plr.Name .. "_ESP") then
                            if
                                plr.Character and getRoot(plr.Character) and
...
function CHMS(plr)
    task.spawn(
        function()
            ...
            wait()
            if
                plr.Character and plr.Name ~= Players.LocalPlayer.Name and
                    not COREGUI:FindFirstChild(plr.Name .. "_CHMS")
             then
                local ESPholder = Instance.new("Folder")
                ...
                CHMSremoved =
                    ESPholder.AncestryChanged:Connect(
                    function()
                        teamChange:Disconnect()
                        addedFunc:Disconnect()
    ...
    if Holder_2 then
        ...
        for i = 1, #binds do
            ...
            if binds[i].TOGGLE then
                ...
                newbind.Text.Text =
                    key .. " > " .. binds[i].COMMAND .. "  " .. (binds[i].ISKEYUP and "(keyup)" or "(keydown)")
            end
            Holder_2.CanvasSize = UDim2.new(0, 0, 0, Position + 30)
            newbind.Text.Delete.MouseButton1Click:Connect(
                function()
...
PositionsFrame.Delete.MouseButton1Click:Connect(
    function()
        execCmd("cpos")
    end
)
...
function refreshwaypoints()
    ...
    if Holder_4 then
        ...
        for i = 1, #WayPoints do
            ...
            newpoint.Text.Delete.MouseButton1Click:Connect(
                function()
                    execCmd("dpos " .. WayPoints[i].NAME)
                end
            )
            newpoint.Text.TP.MouseButton1Click:Connect(
                function()
...
function refreshaliases()
    ...
    if Holder_3 then
        ...
        for i = 1, #aliases do
            ...
            newalias.Text.Delete.MouseButton1Click:Connect(
                function()
...
BindTo.MouseButton1Click:Connect(
    function()
        awaitingInput = true
...
BindTriggerSelect.MouseButton1Click:Connect(
    function()
...
On_2.MouseButton1Click:Connect(
    function()
...
Add_2.MouseButton1Click:Connect(
    function()
        if keySelected then
            if string.find(Cmdbar_2.Text, "\\\\") or string.find(Cmdbar_3.Text, "\\\\") then
                ...
                if keyPressed == "RightClick" or keyPressed == "LeftClick" then
                    notify(
                        "Keybinds Updated",
                        "Binded " ..
                            keyPressed .. " to " .. Cmdbar_2.Text .. (newToggle and " / " .. Cmdbar_3.Text or "")
                    )
                else
                    notify(
                        "Keybinds Updated",
                        "Binded " ..
                            keyPressed:sub(14) ..
                                " to " .. Cmdbar_2.Text .. (newToggle and " / " .. Cmdbar_3.Text or "")
                    )
                end
            end
        end
...
Exit_2.MouseButton1Click:Connect(
    function()
            ...
            if not v.ISKEYUP then
                if
                    (input.UserInputType == Enum.UserInputType.Keyboard and
                        ...
                        (input.UserInputType == Enum.UserInputType.MouseButton2 and v.KEY:lower() == "rightclick")
                 then
                    if v.TOGGLE then
...
ClickTP.Select.MouseButton1Click:Connect(
    function()
        if keySelected then
...
ClickDelete.Select.MouseButton1Click:Connect(
    function()
        if keySelected then
...
IYMouse.Button1Down:Connect(
    function()
        for i, v in pairs(binds) do
            if v.COMMAND == "clicktp" then
                local input = v.KEY
                if
                    input == "RightClick" and UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton2) and
                        Players.LocalPlayer.Character
                 then
                    clicktpFunc()
                elseif
                    input == "LeftClick" and UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1) and
                        Players.LocalPlayer.Character
                 then
                    clicktpFunc()
...
function refreshplugins(dontSave)
    ...
    if Holder_5 then
        ...
        for i, v in pairs(PluginsTable) do
            ...
            newplugin.Text.Delete.MouseButton1Click:Connect(
                function()
                    deletePlugin(pName)
                end
            )
...
AddPlugin.MouseButton1Click:Connect(
    function()
        addPlugin(PluginsGUI.FileName.Text)
    end
)

Exit_3.MouseButton1Click:Connect(
    function()
...
Close_4.MouseButton1Click:Connect(
    function()
        SettingsHolder.Visible = true
    ...
    function(args, speaker)
        ...
        task.spawn(
            function()
                ...
                CopyApp.MouseButton1Click:Connect(
                    function()
                        toClipboard(speaker.CharacterAppearanceId)
                    end
                )
                CopyPlrID.MouseButton1Click:Connect(
                    function()
                        toClipboard(speaker.UserId)
                    end
                )
                CopyPlcID.MouseButton1Click:Connect(
                    function()
                        toClipboard(PlaceId)
                    end
                )
                CopyPlcName.MouseButton1Click:Connect(
                    function()
...
local mobilefly = function(speaker, vfly)
    ...
    mfly2 =
        ...
        function()
            ...
            if
                speaker.Character:FindFirstChildWhichIsA("Humanoid") and root and
                    root:FindFirstChild(velocityHandlerName) and
                    root:FindFirstChild(gyroHandlerName)
             then
...
addcmd(
    "unfly",
    {"nofly", "novfly", "unvehiclefly", "novehiclefly", "unvfly"},
    function(args, speaker)
        if not IsOnMobile then
            NOFLY()
        else
...
addcmd(
    "vflyspeed",
    {"vflysp", "vehicleflyspeed", "vehicleflysp"},
    function(args, speaker)
        local speed = args[1] or 1
        if isNumber(speed) then
...
addcmd(
    ...
    function(args, speaker)
        ...
        CFloop =
            ...
            function(deltaTime)
                local moveDirection =
                    speaker.Character:FindFirstChildOfClass("Humanoid").MoveDirection * (CFspeed * deltaTime)
...
addcmd(
    "setwaypoint",
    {"swp", "setwp", "spos", "saveposition", "savepos"},
    function(args, speaker)
...
addcmd(
    "deletewaypoint",
    {"dwp", "dpos", "deleteposition", "deletepos"},
    function(args, speaker)
...
addcmd(
    "clearwaypoints",
    {"cwp", "clearpositions", "cpos", "clearpos"},
    function(args, speaker)
        WayPoints = {}
        pWayPoints = {}
        refreshwaypoints()
...
addcmd(
    ...
    function(args, speaker)
        ...
        oldhmmnc =
            ...
            function(self, ...)
                if
                    self == TeleportService and getnamecallmethod():lower() == "teleport" or
...
local function StepFreecam(dt)
    ...
    local cameraCFrame =
        CFrame.new(cameraPos) * CFrame.fromOrientation(cameraRot.x, cameraRot.y, 0) *
...
addcmd(
    "freecampos",
    {"fcpos", "fcp", "freecamposition", "fcposition"},
    function(args, speaker)
        if not args[1] then
            return
        end
...
addcmd(
    "deletevelocity",
    {"dv", "removevelocity", "removeforces"},
    function(args, speaker)
        for i, v in pairs(speaker.Character:GetDescendants()) do
            if
...
addcmd(
    "vehicleclip",
    {"vclip", "unvnoclip", "unvehiclenoclip"},
    function(args, speaker)
        execCmd("clip")
                        ...
                        repeat
                            for i, c in pairs(players) do
                                if Players:FindFirstChild(v) then
                                    ...
                                    if
                                        pchar ~= nil and Players[v].Character ~= nil and getRoot(pchar) and
                                            speaker.Character ~= nil and
                                            getRoot(speaker.Character)
                                     then
                ...
                function()
                    pcall(
                        function()
                            ...
                            root.CFrame =
                                CFrame.new(getRoot(target.Character).Position) * CFrame.Angles(0, math.rad(rotation), 0) *
    ...
    function(args, speaker)
        if r15(speaker) then
            for i, v in pairs(speaker.Character:GetChildren()) do
                if
                    v:IsA("BasePart") and v.Name == "RightUpperLeg" or v.Name == "LeftUpperLeg" or
            ...
            for i, v in pairs(speaker.Character:GetChildren()) do
                if
                    v:IsA("BasePart") and v.Name == "Right Leg" or v.Name == "Left Leg" or v.Name == "Right Arm" or
                        v.Name == "Left Arm"
                 then
                    v:Destroy()
                end
...
addcmd(
    ...
    function(args, speaker)
        ...
        noSit =
            Players.LocalPlayer.Character:FindFirstChildOfClass("Humanoid"):GetPropertyChangedSignal("Sit"):Connect(
            noSitFunc
        )
...
addcmd(
    "uninfjump",
    {"uninfinitejump", "noinfjump", "noinfinitejump"},
    function(args, speaker)
        if infJump then
            infJump:Disconnect()
        end
    ...
    function(args, speaker)
        ...
        local function edgejump()
            if Char and Human then
                ...
                if
                    laststate ~= state and state == Enum.HumanoidStateType.Freefall and
                        laststate ~= Enum.HumanoidStateType.Jumping
                 then
...
addcmd(
    "refreshanimations",
    {"refreshanimation", "refreshanims", "refreshanim"},
    function(args, speaker)
    ...
    function(args, speaker)
        ...
        TpTool.Activated:Connect(
            function()
                ...
                HRP.CFrame =
                    CFrame.new(IYMouse.Hit.X, IYMouse.Hit.Y + 3, IYMouse.Hit.Z, select(4, HRP.CFrame:components()))
            end
        )
    end
)
...
addcmd(
    "getposition",
    {"getpos", "notifypos", "notifyposition"},
    function(args, speaker)
        local players = getPlayer(args[1], speaker)
        for i, v in pairs(players) do
            local char = Players[v].Character
            ...
            if hookmetamethod then
                ...
                index =
                    ...
                    function(self, key)
                        ...
                        if
                            (keyclean == "WalkSpeed" or keyclean == "walkSpeed") and self:IsA("Humanoid") and
                                self:IsDescendantOf(char) and
                                not checkcaller()
                         then
...
addcmd(
    ...
    function(args, speaker)
        ...
        if isNumber(speed) then
            ...
            HumanModCons.wsCA =
                (HumanModCons.wsCA and HumanModCons.wsCA:Disconnect() and false) or
                speaker.CharacterAdded:Connect(
                    function(nChar)
                        Char, Human = nChar, nChar:WaitForChild("Humanoid")
                        WalkSpeedChange()
            ...
            if hookmetamethod then
                ...
                index =
                    ...
                    function(self, key)
                        local keyclean = key:gsub("\0", "")
                        if
                            (keyclean == "JumpPower" or keyclean == "jumpPower") and self:IsA("Humanoid") and
                                self:IsDescendantOf(char) and
                                not checkcaller()
                         then
...
addcmd(
    ...
    function(args, speaker)
        ...
        if isNumber(jpower) then
            ...
            JumpPowerChange()
            HumanModCons.jpLoop =
                (HumanModCons.jpLoop and HumanModCons.jpLoop:Disconnect() and false) or
                Human:GetPropertyChangedSignal("JumpPower"):Connect(JumpPowerChange)
            HumanModCons.jpCA =
                (HumanModCons.jpCA and HumanModCons.jpCA:Disconnect() and false) or
                speaker.CharacterAdded:Connect(
                    function(nChar)
                        Char, Human = nChar, nChar:WaitForChild("Humanoid")
                        JumpPowerChange()
                ...
                local Fenv, RealFenv, FenvMt = {},
                    {
                        ...
                        getreg = function()
                            -- It loops registry for some idiotic reason so stop it from doing that and just use a global
                ...
                function()
                    if
                        Players:FindFirstChild(Players[v].Name) and Players[v].Character ~= nil and
                            getRoot(Players[v].Character) and
                            getRoot(speaker.Character) and
                            speaker.Character:FindFirstChildOfClass("Humanoid").Sit == true
                     then
                        getRoot(speaker.Character).CFrame =
                            getRoot(Players[v].Character).CFrame * CFrame.Angles(0, math.rad(0), 0) *
    ...
    function(args, speaker)
        ...
        for i = 1, LOOP_NUM do
            ...
            speaker.CharacterAdded:Wait():WaitForChild("Humanoid").Parent:MoveTo(
                LOOP_NUM == i and OrigPos or TempPos,
                wait(.1)
            )
...
addcmd(
    "unstun",
    {"nostun", "unplatformstand", "noplatformstand"},
    function(args, speaker)
        speaker.Character:FindFirstChildOfClass("Humanoid").PlatformStand = false
    end
)
                ...
                function()
                    while Tool and speaker.Character and v.Character and Tool.Parent == speaker.Character do
                        ...
                        for _, v1 in ipairs(v.Character.GetChildren(v.Character)) do
                            v1 =
                                ((v1.IsA(v1, "BasePart") and
                                firetouchinterest(
                                    Handle,
                                    v1,
                                    1,
                                    (RS.Wait(RS) and nil) or firetouchinterest(Handle, v1, 0)
                                ) and
                                nil) or
                                v1) or
                                v1
...
xray = function()
    for _, v in pairs(workspace:GetDescendants()) do
        if
            v:IsA("BasePart") and not v.Parent:FindFirstChildWhichIsA("Humanoid") and
                not v.Parent.Parent:FindFirstChildWhichIsA("Humanoid")
         then
...
addcmd(
    ...
    function(args, speaker)
        ...
        local function touchedFunc(hit)
            local Root = getRoot(speaker.Character)
            if
                hit:IsA("BasePart") and
                    hit.Position.Y > Root.Position.Y - speaker.Character:FindFirstChildOfClass("Humanoid").HipHeight
             then
        ...
        if mouse1press and mouse1release then
            ...
            cancelAutoClick =
                ...
                function(input, gameProcessedEvent)
                    if not gameProcessedEvent then
                        if
                            (input.KeyCode == Enum.KeyCode.Backspace and UserInputService:IsKeyDown(Enum.KeyCode.Equals)) or
                                (input.KeyCode == Enum.KeyCode.Equals and
                                    UserInputService:IsKeyDown(Enum.KeyCode.Backspace))
                         then
                            autoclicking = false
...
addcmd(
    ...
    function(args, speaker)
        ...
        for i, v in pairs(players) do
            ...
            if
                not Players.LocalPlayer.Character:FindFirstChild("HumanoidRootPart") and
            ...
            local function stareFunc()
                if
                    Players.LocalPlayer.Character.PrimaryPart and Players:FindFirstChild(v) and
                        Players[v].Character ~= nil and
                        Players[v].Character:FindFirstChild("HumanoidRootPart")
                 then
...
addcmd(
    ...
    function(args, speaker)
        if
            speaker and speaker.Character and speaker.Character:FindFirstChildOfClass("Humanoid") and
                getRoot(speaker.Character)
         then
            local hum = speaker.Character:FindFirstChildOfClass("Humanoid")
            local root = getRoot(speaker.Character)
...
addcmd(
    "thawunanchored",
    {"thawua", "unfreezeunanchored", "unfreezeua"},
    function(args, speaker)
        if freezingua then
    ...
    function(args, speaker)
        ...
        for i, v in pairs(players) do
            ...
            for _, part in pairs(workspace:GetDescendants()) do
                if
                    Players[v].Character:FindFirstChild("Head") and part:IsA("BasePart" or "UnionOperation" or "Model") and
                        part.Anchored == false and
                        not part:IsDescendantOf(speaker.Character) and
                        part.Name == "Torso" == false and
                        part.Name == "Head" == false and
                        part.Name == "Right Arm" == false and
                        part.Name == "Left Arm" == false and
                        part.Name == "Right Leg" == false and
                        part.Name == "Left Leg" == false and
...
addcmd(
    "unautokeypress",
    {"noautokeypress", "unkeypress", "nokeypress"},
    function(args, speaker)
        autoKeyPressing = false
        if cancelAutoKeyPress then
            cancelAutoKeyPress:Disconnect()
...
if IsOnMobile then
    ...
    QuickCapture.MouseButton1Click:Connect(
        function()
            Cmdbar:CaptureFocus()
            maximizeHolder()
        end
...
task.spawn(
    function()
        local success, latestVersionInfo =
            pcall(
            function()
                local versionJson =
                    game:HttpGet("https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/version")
